...
class Admin::ContentController < Admin::BaseController
  ...
  def merge
# find the ID of the article the admin submitted
    @article1 = Article.find(params[:merge_with])
# find the ID of the article the admin was on
...
# delete article2
    article2.destroy
    flash[:notice] = _("Articles have been merged")
    redirect_to :action => 'index'
  end
